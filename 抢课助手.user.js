...
var btnDomain = $('.button_domain');
if (btnDomain.length) {
    var toggleBtn = $('<button id="auto-confirm-toggle" style="background:#2a3a8a;color:#fff;border:1px white solid;cursor:pointer;display:block;margin:5px;width:100px;height:50px;">自动确认: 关闭</button>');
    btnDomain.append(toggleBtn);
