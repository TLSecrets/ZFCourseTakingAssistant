...
(() => {
    var __webpack_modules__ = {
        364: n => {
            ...
            (e = t = function() {
                ...
                function t() {
                    var n = "";
                    if (null == (_ = k.buttons) && (_ = [], 1 != k.showCancelButton && (0 == k.showCancelButton || "warning" != k.type && "input" != k.type) || _.push({ type: "cancel", key: 27 }), "text" == k.type || "input" == k.type ? _.push({ type: "info", key: 13 }) : _.push({ type: k.type, key: 13 })), 0 == _.length) return "";
                    ...
                    for (var i = 0; i < _.length; ++i) { var r = _[i];
                        n += "<" + e + ' id="x0p-button-' + i + '" class="button button-' + r.type + a + '" style="' + o + '">' + p(r) + "</" + e + ">" }
                    return n + "</div>"
                }

                function a(n) { var e = document.getElementById(n); null != e && e.parentNode.removeChild(e) }

                function i() { h.classList.remove("noscroll"), document.removeEventListener("keydown", s), a("x0popup"), a("x0p-overlay") }

                function r() { document.getElementById("x0p-buttons").innerHTML = '<div class="x0l"><div class="ball ball-4"></div><div class="ball ball-3"></div><div class="ball ball-2"></div><div class="ball ball-1"></div></div>' }

                function l() {
                    for (var n = _.length - 1, e = 0; e < _.length; ++e) { var t = document.getElementById("x0p-button-" + e); ! function(n, e) { t.addEventListener("click", function() { c(n, e) }) }(_[e].type, _[e].showLoading), t.addEventListener("mousedown", function(n) { n.preventDefault ? n.preventDefault() : n.returnValue = !1 }), 1 == _[e].default && (n = e) }
                    k.keyResponse && _.length > 0 ? (document.getElementById("x0p-button-" + (_.length - 1)).addEventListener("keydown", function(n) { 9 == n.keyCode && (document.getElementById("x0p-button-0").focus(), n.preventDefault ? n.preventDefault() : n.returnValue = !1) }), document.getElementById("x0p-button-" + n).focus()) : document.activeElement.blur()
                }

                function s(n) {
                    for (var e = n.keyCode, t = 0; t < _.length; ++t)
                        if (e == _[t].key) { var o = document.getElementById("x0p-button-" + t);
                            n.preventDefault ? n.preventDefault() : n.returnValue = !1, o && o.click() }
                }

                function c(n, e) {
                    if (null != document.getElementById("x0popup")) { var t = document.getElementById("x0p-input"); if ("cancel" != n && null != $ && null != t) { if (null != k.inputPromise) return void k.inputPromise(n, t.value).then(function(t) { null != t ? u(t) : d(n, e) }); if (null != k.inputValidator) { var o = k.inputValidator(n, t.value); if (null != o) return void u(o) } } d(n, e) }
                }
                ...
                function d(n, e) {
                    ...
                    null != b && b(n, a, i), v({ button: n, text: a, close: i, data: o })
                }

                function u(n) { a("x0p-input-error"), document.getElementById("x0p-input-anchor").insertAdjacentHTML("beforeend", '<div id="x0p-input-error" class="error">' + n + "</div>") }
                ...
                function f() { var n = k.inputColor; return null == n ? "" : "<style>#x0p-input:focus { border-color:" + n + "; color:" + n + "; }</style>" }

                function m(n) { var e = document.createElement("div"); return e.innerText = e.textContent = n, e.innerHTML }
                var _, x = arguments[0],
                    b = null,
                ...
                else { for (var y in x) k[y] = x[y]; null != arguments[1] && (b = arguments[1]) }
                var v, w = "",
                    ...
                    T = new Promise(function(t, o) {
                        ...
                        null != $ && a.focus(), null != k.autoClose && (g = setTimeout(function() { c("timeout") }, k.autoClose))
                    });
                return T
            }).setDefault = t.setDefault = function() { var n = arguments[0]; for (var e in n) o[e] = n[e] }, n.exports = e
        },
        354: (n, e, t) => {
            "use strict";
            t.d(e, { Z: () => i });
            var o = t(464),
                a = t.n(o)()(function(n) { return n[1] });
        ...
        464: n => {
            ...
            n.exports = function(n) {
                var e = [];
                return e.toString = function() { return this.map(function(e) { var t = n(e); return e[2] ? "@media ".concat(e[2], " {").concat(t, "}") : t }).join("") }, e.i = function(n, t, o) {
                    "string" == typeof n && (n = [
                        [null, n, ""]
                    ]);
                    var a = {};
                    if (o)
                        for (var i = 0; i < this.length; i++) { var r = this[i][0]; null != r && (a[r] = !0) }
                    for (var l = 0; l < n.length; l++) { var s = [].concat(n[l]);
        ...
        574: (n, e, t) => {
            ...
            var o, a = function() {
                    var n = {};
                    return function(e) {
                        if (void 0 === n[e]) { var t = document.querySelector(e); if (window.HTMLIFrameElement && t instanceof window.HTMLIFrameElement) try { t = t.contentDocument.head } catch (n) { t = null } n[e] = t }
                        return n[e]
                    }
                }(),
                i = [];

            function r(n) { for (var e = -1, t = 0; t < i.length; t++)
                    if (i[t].identifier === n) { e = t; break } return e }

            function l(n, e) {
                for (var t = {}, o = [], a = 0; a < n.length; a++) { var l = n[a],
                    ...
                    -1 !== u ? (i[u].references++, i[u].updater(p)) : i.push({ identifier: d, updater: _(p, e), references: 1 }), o.push(d) }
                return o
            }
            ...
            function s(n) {
                var e = document.createElement("style"),
                    o = n.attributes || {};
                if (void 0 === o.nonce) { var i = t.nc;
                    i && (o.nonce = i) }
                if (Object.keys(o).forEach(function(n) { e.setAttribute(n, o[n]) }), "function" == typeof n.insert) n.insert(e);
                else { var r = a(n.insert || "head"); if (!r) throw new Error("Couldn't find a style target. This probably means that the value for the 'insert' parameter is invalid.");
                    r.appendChild(e) }
                return e
            }
            var c, d = (c = [], function(n, e) { return c[n] = e, c.filter(Boolean).join("\n") });
            ...
            function _(n, e) {
                ...
                if (e.singleton) { var i = m++;
                    t = f || (f = s(e)), o = u.bind(null, t, i, !1), a = u.bind(null, t, i, !0) } else t = s(e), o = p.bind(null, t, e), a = function() { ! function(n) { if (null === n.parentNode) return !1;
                        n.parentNode.removeChild(n) }(t) };
                return o(n), function(e) { if (e) { if (e.css === n.css && e.media === n.media && e.sourceMap === n.sourceMap) return;
                        o(n = e) } else a() }
            }
            n.exports = function(n, e) {
                ...
                return function(n) {
                    if (n = n || [], "[object Array]" === Object.prototype.toString.call(n)) {
                        for (var o = 0; o < t.length; o++) { var a = r(t[o]);
                            i[a].references-- }
                        for (var s = l(n, e), c = 0; c < t.length; c++) { var d = r(t[c]);
        ...
        147: n => {
            "use strict";
            n.exports = JSON.parse('{"name":"zf_course_take_assistant","version":"1.1.6","newVersionDescription":"修复x0p未定义、移除版本检查、完善自动确认","description":"Auto fetch courses. (Modified by TLSecrets)","main":"抢课助手.user.js","scripts":{"dev":"webpack --mode development","build":"webpack --mode production"},"author":"VoidJackLee (original), TLSecrets (modifications)","license":"GPL-2.0"}')
        }
    };
    ...
    function __webpack_require__(n) {
        ...
        var t = __webpack_module_cache__[n] = { id: n, exports: {} };
    ...
    (() => {
        ...
        function run() {
            ...
            function fetchType() {
                let n, e, t, o = [],
                    a = $("#nav_tab").find("li a");
                if (0 === a.length) n = { kklxdm: $("#kklxdm").val(), xkkz_id: $("#xkkz_id").val(), njdm_id: $("#njdm_id").val(), zyh_id: $("#zyh_id").val() }, o.push(n);
                else
                    for (let i in a)
                        if (n = { kklxdm: "", xkkz_id: "", njdm_id: "", zyh_id: "" }, e = a[i].onclick, null != e) { e = e.toString().match(/queryCourse.*\)/)[0], t = 0; for (let o in e) "'" === e[o] ? t++ : 1 === t ? n.kklxdm += e[o] : 3 === t ? n.xkkz_id += e[o] : 5 === t ? n.njdm_id += e[o] : 7 === t && (n.zyh_id += e[o]);
                            o[i] = n }
                return o
            }
            ...
            function display(n) {
                console.log(n);
                for (let e in n) { ok = !0; for (let t in n[e]) "course_name" != t && (ok &= n[e][t].jxbrl == n[e][t].jxbrs);
            ...
            setTimeout(function() { display(data) }, 100), $("#load").css("display", "none"), $("#ok").css("display", "flex")
        }
            ...
            if (!isEnabled) {
                window.x0p({
                    ...
                    if (result.button === 'ok') {
                        ...
                        window.x0p({ title: '已开启', text: '自动确认已启用，请谨慎操作。', type: 'info' });
                    }
                });
            } else {
                ...
                window.x0p({ title: '已关闭', text: '自动确认已禁用。', type: 'info' });
            }
        });
    }
